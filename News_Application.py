...
class NewsApp:
    ...
    def load_news_item(self, index):
        ...
        try:
            ...
            self.photo = ImageTk.PhotoImage(im)  # Keep a reference to avoid garbage collection
        except:
        ...
        description = self.data['articles'][index]['description'] or 'No description available'
        details = Label(self.root, text=description, bg='black', fg='white', wraplength=350, justify='center')
